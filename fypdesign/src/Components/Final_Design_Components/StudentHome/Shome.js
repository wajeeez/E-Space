    ...
    <div className="row">
      <div className="col-md-3 p-2" >
        <div className="card h-100 text-white" style={{ background: bg, borderRadius: '20px' , border:'1px solid #8539d1', boxShadow: '7px 7px 5px rgba(0, 0, 0, 0.2)'}}>
          ...
          <Link to={`https://sfu.mirotalk.com/join?room=${_id}&roomPassword=${_id}&name=${std}&audio=0&video=1&screen=0&hide=0&notify=1`} target="_blank" style={{textDecoration:'none'}}>
