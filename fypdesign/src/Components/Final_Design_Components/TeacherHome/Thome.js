              ...
              <div className="card-body">
                ...
                <div className="d-flex justify-content-between align-items-center">
                  <div style={{ marginLeft: '20px' }}>
                    <h2 className="card-title" style={{ fontFamily: 'Arial, sans-serif', fontWeight: 'bold' }}>Hi, {name}</h2>
            ...
            <div className="row">
              ...
              <div className="col-md-6">
                ...
                <div className="card-body" style={{ textAlign: 'center' }}>
                    ...
                    <p className="card-text" style={{ fontFamily: 'Helvetica, sans-serif' }}>Average Present</p>
                  </div>
                </div>
              </div>
